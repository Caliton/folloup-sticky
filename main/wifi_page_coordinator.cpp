...
constexpr const char* kPasswordLabel = "Senha";
constexpr const char* kPasswordPlaceholder = "Digite a senha";
...
epaper_ui::WifiPageState WifiPageCoordinator::BuildState() const
{
    ...
    state.connect_button = {
        .label_text = SelectedNetworkIsCurrent() ? "Desconectar" : "Conectar",
